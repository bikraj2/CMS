...
class Command(BaseCommand):
    help = 'Sends an email reminder to users registered more than N days that are not enrolled to any coures yet'

    def add_arguments(self, parser):
        parser.add_argument('--days', type=int, help='Number of days before enrollment reminder')
